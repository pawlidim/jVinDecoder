...
/**
 * Vehicle Descriptor Section (VDS) is part of the VIN its 4th through 9th
 * positions in the VIN. VDS is used to specify a type of vehicle and may
 * include information about the model, platform, body, engine and transmission.
 * Each manufacturer has a unique system for using this field. Most
 * manufacturers since the 1980s have used the 8th digit to identify the engine
 * type whenever there is more than one engine choice for the vehicle.
 * 
 * @author PAWLIDIM
 *
 */
@DatabaseTable(tableName = VehicleDescriptorSection.NAME)
public class VehicleDescriptorSection extends BaseModel {

	/** Defines the database table name */
	static final String NAME = "VDS";
	 ...
	 */
	public VehicleDescriptorSection() {
		super();
	}
